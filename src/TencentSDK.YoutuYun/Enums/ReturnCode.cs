namespace TencentSDK.YoutuYun.Enums
{
    ...
    public enum ReturnCode
    {
        ...
        /// </summary>
        请求包体太大_HTTP_REQUEST_OVERFLOW = 425,
        ...
        /// </summary>
        服务内部错误_HTTP_INTERNAL_SERVER_ERROR = 500,
        ...
        /// </summary>
        服务内部错误_OCR_SERVER_INTERN_ERROR = -5208,
        ...
        /// </summary>
        OCR识别失败_DLOCR_RECONG_FAILED = -9002,

        /// <summary>
        /// OCR识别失败
        /// 说明：GLOCR_RECONG_FAILED
        /// </summary>
        OCR识别失败_GLOCR_RECONG_FAILED = -9003,
        ...
        /// </summary>
        营业执照OCR_BIZLICENSE_OCR_PREPROCESS_FAILED = -9501,

        /// <summary>
        /// 营业执照OCR
        /// 说明：BIZLICENSE_OCR_RECOG_FAILED
        /// </summary>
        营业执照OCR_BIZLICENSE_OCR_RECOG_FAILED = -9502,
